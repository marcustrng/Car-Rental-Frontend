  ...
  return (
    <div className="col-md-12 col-lg-4 col-xl-3">
      ...
      <div className="p-3 rounded" style={{background: '#f3f3f3'}}>
        ...
        <div className='mb-3'>
          <h6 style={{color: '#05335c'}}>Branch</h6>
        ...
        <Button className='w-100 mt-4 mb-2' type="primary"
                style={{backgroundColor: '#1977cc'}} shape="round"
                icon={<FaSearch/>} size="sm">Search</Button>
        {
